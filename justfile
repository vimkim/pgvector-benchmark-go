...
bench-256-75000:
    go bench main.go --database vimkimdb --table tbl_256_75000 -u vimkim --dim 256 --rows 75000 > tbl_256_75000.txt

bench-256-150000:
    go bench main.go --database vimkimdb --table tbl_256_150000 -u vimkim --dim 256 --rows 150000 > tbl_256_150000.txt

bench-256-300000:
    go bench main.go --database vimkimdb --table tbl_256_300000 -u vimkim --dim 256 --rows 300000 > tbl_256_300000.txt

bench-768-75000:
    go bench main.go --database vimkimdb --table tbl_768_75000 -u vimkim --dim 768 --rows 75000 > tbl_768_75000.txt

bench-768-150000:
    go bench main.go --database vimkimdb --table tbl_768_150000 -u vimkim --dim 768 --rows 150000 > tbl_768_150000.txt

bench-768-300000:
    go bench main.go --database vimkimdb --table tbl_768_300000 -u vimkim --dim 768 --rows 300000 > tbl_768_300000.txt

bench-1536-75000:
    go bench main.go --database vimkimdb --table tbl_1536_75000 -u vimkim --dim 1536 --rows 75000 > tbl_1536_75000.txt

bench-1536-150000:
    go bench main.go --database vimkimdb --table tbl_1536_150000 -u vimkim --dim 1536 --rows 150000 > tbl_1536_150000.txt

bench-1536-300000:
    go bench main.go --database vimkimdb --table tbl_1536_300000 -u vimkim --dim 1536 --rows 300000 > tbl_1536_300000.txt
